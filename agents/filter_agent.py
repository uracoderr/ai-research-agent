...
def filter_and_rank_articles(articles: list, top_n: int = 40) -> tuple:
    console.print(f"\n[step]▶ PHASE 2: CREDIBILITY RANKING (NVIDIA LLM)[/step]")
    ...
    for attempt in range(1, max_retries + 1):
        try:
            ...
            # Sort final list to ensure highest credibility is scraped first
            ...
            console.print(f"[success]✅ LLM Ranking Success! Top {len(ranked_articles)} selected and sorted by credibility.[/success]")
